...
- The theorist phase is conditional -- only for statistical/measurement methods, theory+empirics, metric-validation studies, or methodological causal-design papers. Applied papers using off-the-shelf estimators skip it.
